...
module LambdaBoxMutt :
 sig
  ...
  | TPrim of primitive
  | TWrong of String.t
  and coq_Terms = Compile0.coq_Terms =
  | Coq_tnil
  | Coq_tcons of coq_Term * coq_Terms
  and coq_Brs = Compile0.coq_Brs =
  | Coq_bnil
  | Coq_bcons of name list * coq_Term * coq_Brs
  and coq_Defs = Compile0.coq_Defs =
  | Coq_dnil
  ...
  type coq_R_tlength = Compile0.coq_R_tlength =
  ...
  type coq_R_blength = Compile0.coq_R_blength =
  ...
  type coq_R_tappend = Compile0.coq_R_tappend =
  ...
  type coq_R_lift = Compile0.coq_R_lift =
  ...
  type 't trans_prim_val_graph = 't Compile0.trans_prim_val_graph =
  ...
  type compile_graph = Compile0.compile_graph =
  | Coq_compile_graph_refinement_1 of term * compile_clause_1_graph
  and compile_clause_1_graph = Compile0.compile_clause_1_graph =
  ...
  | Coq_compile_clause_1_graph_equation_6 of name * term * term
  ...
  and compile_clause_1_clause_12_graph = Compile0.compile_clause_1_clause_12_graph =
  | Coq_compile_clause_1_clause_12_graph_equation_1 of term prim_val
     * primitive
...
val trans_fixes :
  (coq_N -> LambdaBoxMutt.coq_Term -> exp) -> coq_N -> LambdaBoxMutt.coq_Defs
  -> efnlst
...
val translate_env_aux :
  ((((kername * String.t) * bool) * nat) * positive) list -> coq_Term environ
  -> env -> env
