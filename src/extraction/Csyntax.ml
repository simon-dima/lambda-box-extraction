...
(** val expr_rect :
    ...
    exprlist -> coq_type -> 'a1) -> (block -> Ptrofs.int -> bitfield ->
    coq_type -> 'a1) -> (expr -> 'a1 -> coq_type -> coq_type -> 'a1) -> expr
    -> 'a1 **)
...
| Eloc (b, ofs, bf, ty) -> f19 b ofs bf ty
| Eparen (r, tycast, ty) ->
  f20 r
    (expr_rect f f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 f14 f15 f16
...
let coq_Eselection r1 r2 r3 ty =
  ...
  false, true, false)), (String ((Ascii (true, true, true, true, true, false,
  true, false)), (String ((Ascii (false, true, false, false, false, true,
  true, false)), (String ((Ascii (true, false, true, false, true, true, true,
  ...
  false)), (String ((Ascii (false, false, true, true, false, true, true,
  false)), EmptyString)))))))))))))))))))))))))), sg)), (Tcons (type_bool,
  (Tcons (ty, (Tcons (ty, Tnil)))))), (Econs (r1, (Econs (r2, (Econs (r3,
  Enil)))))), ty)
