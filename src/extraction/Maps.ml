  ...
  let rec tree_rec2' base base1 base2 nodes m1 m2 =
    ...
    | Node001 t0 ->
      (match m2 with
       ...
       | Node010 b ->
         nodes Empty None (Nodes t0) Empty (Some b) Empty base
           (base2 (Nodes t0))
       | Node011 (b, t1) ->
         nodes Empty None (Nodes t0) Empty (Some b) (Nodes t1) base
           (tree_rec2' base base1 base2 nodes t0 t1)
       | Node100 t1 ->
       ...
       | Node110 (t1, b) ->
         nodes Empty None (Nodes t0) (Nodes t1) (Some b) Empty
           (base1 (Nodes t1)) (base2 (Nodes t0))
       | Node111 (t1, b, t2) ->
         nodes Empty None (Nodes t0) (Nodes t1) (Some b) (Nodes t2)
           (base1 (Nodes t1)) (tree_rec2' base base1 base2 nodes t0 t2))
    | Node010 a ->
      (match m2 with
       | Node001 t0 ->
         nodes Empty (Some a) Empty Empty None (Nodes t0) base
           (base1 (Nodes t0))
       | Node010 b ->
         nodes Empty (Some a) Empty Empty (Some b) Empty base base
       | Node011 (b, t0) ->
         nodes Empty (Some a) Empty Empty (Some b) (Nodes t0) base
           (base1 (Nodes t0))
       | Node100 t0 ->
       ...
       | Node110 (t0, b) ->
         nodes Empty (Some a) Empty (Nodes t0) (Some b) Empty
           (base1 (Nodes t0)) base
       | Node111 (t0, b, t1) ->
         nodes Empty (Some a) Empty (Nodes t0) (Some b) (Nodes t1)
           (base1 (Nodes t0)) (base1 (Nodes t1)))
    | Node011 (a, t0) ->
      (match m2 with
       | Node001 t1 ->
         nodes Empty (Some a) (Nodes t0) Empty None (Nodes t1) base
           (tree_rec2' base base1 base2 nodes t0 t1)
       | Node010 b ->
         nodes Empty (Some a) (Nodes t0) Empty (Some b) Empty base
           (base2 (Nodes t0))
       | Node011 (b, t1) ->
         nodes Empty (Some a) (Nodes t0) Empty (Some b) (Nodes t1) base
           (tree_rec2' base base1 base2 nodes t0 t1)
       | Node100 t1 ->
       ...
       | Node101 (t1, t2) ->
         nodes Empty (Some a) (Nodes t0) (Nodes t1) None (Nodes t2)
           (base1 (Nodes t1)) (tree_rec2' base base1 base2 nodes t0 t2)
       | Node110 (t1, b) ->
         nodes Empty (Some a) (Nodes t0) (Nodes t1) (Some b) Empty
           (base1 (Nodes t1)) (base2 (Nodes t0))
       | Node111 (t1, b, t2) ->
         nodes Empty (Some a) (Nodes t0) (Nodes t1) (Some b) (Nodes t2)
           (base1 (Nodes t1)) (tree_rec2' base base1 base2 nodes t0 t2))
    | Node100 t0 ->
      (match m2 with
       | Node001 t1 ->
         nodes (Nodes t0) None Empty Empty None (Nodes t1) (base2 (Nodes t0))
           (base1 (Nodes t1))
       | Node010 b ->
         nodes (Nodes t0) None Empty Empty (Some b) Empty (base2 (Nodes t0))
           base
       | Node011 (b, t1) ->
         nodes (Nodes t0) None Empty Empty (Some b) (Nodes t1)
       ...
       | Node110 (t1, b) ->
         nodes (Nodes t0) None Empty (Nodes t1) (Some b) Empty
           (tree_rec2' base base1 base2 nodes t0 t1) base
       | Node111 (t1, b, t2) ->
         nodes (Nodes t0) None Empty (Nodes t1) (Some b) (Nodes t2)
           (tree_rec2' base base1 base2 nodes t0 t1) (base1 (Nodes t2)))
    | Node101 (t0, t1) ->
      (match m2 with
       | Node001 t2 ->
       ...
       | Node010 b ->
         nodes (Nodes t0) None (Nodes t1) Empty (Some b) Empty
           (base2 (Nodes t0)) (base2 (Nodes t1))
       | Node011 (b, t2) ->
         nodes (Nodes t0) None (Nodes t1) Empty (Some b) (Nodes t2)
           (base2 (Nodes t0)) (tree_rec2' base base1 base2 nodes t1 t2)
       | Node100 t2 ->
       ...
       | Node110 (t2, b) ->
         nodes (Nodes t0) None (Nodes t1) (Nodes t2) (Some b) Empty
           (tree_rec2' base base1 base2 nodes t0 t2) (base2 (Nodes t1))
       | Node111 (t2, b, t3) ->
         nodes (Nodes t0) None (Nodes t1) (Nodes t2) (Some b) (Nodes t3)
           (tree_rec2' base base1 base2 nodes t0 t2)
           (tree_rec2' base base1 base2 nodes t1 t3))
    | Node110 (t0, a) ->
      (match m2 with
       | Node001 t1 ->
         nodes (Nodes t0) (Some a) Empty Empty None (Nodes t1)
           (base2 (Nodes t0)) (base1 (Nodes t1))
       | Node010 b ->
         nodes (Nodes t0) (Some a) Empty Empty (Some b) Empty
           (base2 (Nodes t0)) base
       | Node011 (b, t1) ->
         nodes (Nodes t0) (Some a) Empty Empty (Some b) (Nodes t1)
           (base2 (Nodes t0)) (base1 (Nodes t1))
       | Node100 t1 ->
       ...
       | Node101 (t1, t2) ->
         nodes (Nodes t0) (Some a) Empty (Nodes t1) None (Nodes t2)
           (tree_rec2' base base1 base2 nodes t0 t1) (base1 (Nodes t2))
       | Node110 (t1, b) ->
         nodes (Nodes t0) (Some a) Empty (Nodes t1) (Some b) Empty
           (tree_rec2' base base1 base2 nodes t0 t1) base
       | Node111 (t1, b, t2) ->
         nodes (Nodes t0) (Some a) Empty (Nodes t1) (Some b) (Nodes t2)
           (tree_rec2' base base1 base2 nodes t0 t1) (base1 (Nodes t2)))
    | Node111 (t0, a, t1) ->
      (match m2 with
       | Node001 t2 ->
         nodes (Nodes t0) (Some a) (Nodes t1) Empty None (Nodes t2)
           (base2 (Nodes t0)) (tree_rec2' base base1 base2 nodes t1 t2)
       | Node010 b ->
         nodes (Nodes t0) (Some a) (Nodes t1) Empty (Some b) Empty
           (base2 (Nodes t0)) (base2 (Nodes t1))
       | Node011 (b, t2) ->
         nodes (Nodes t0) (Some a) (Nodes t1) Empty (Some b) (Nodes t2)
           (base2 (Nodes t0)) (tree_rec2' base base1 base2 nodes t1 t2)
       | Node100 t2 ->
       ...
       | Node101 (t2, t3) ->
         nodes (Nodes t0) (Some a) (Nodes t1) (Nodes t2) None (Nodes t3)
           ...
           (tree_rec2' base base1 base2 nodes t1 t3)
       | Node110 (t2, b) ->
         nodes (Nodes t0) (Some a) (Nodes t1) (Nodes t2) (Some b) Empty
           (tree_rec2' base base1 base2 nodes t0 t2) (base2 (Nodes t1))
       | Node111 (t2, b, t3) ->
         nodes (Nodes t0) (Some a) (Nodes t1) (Nodes t2) (Some b) (Nodes t3)
           (tree_rec2' base base1 base2 nodes t0 t2)
           (tree_rec2' base base1 base2 nodes t1 t3))
         ...
         let rec tree_rec2'0 m3 m4 =
           ...
           | Node001 t0 ->
             (match m4 with
              ...
              | Node010 b ->
                coq_Node Empty (f None (Some b)) (combine_l (Nodes t0))
              | Node011 (b, t1) ->
                coq_Node Empty (f None (Some b)) (tree_rec2'0 t0 t1)
              | Node100 t1 ->
                coq_Node (combine_r (Nodes t1)) None (combine_l (Nodes t0))
              | Node101 (t1, t2) ->
                coq_Node (combine_r (Nodes t1)) None (tree_rec2'0 t0 t2)
              | Node110 (t1, b) ->
                coq_Node (combine_r (Nodes t1)) (f None (Some b))
                  (combine_l (Nodes t0))
              | Node111 (t1, b, t2) ->
                coq_Node (combine_r (Nodes t1)) (f None (Some b))
                  (tree_rec2'0 t0 t2))
           | Node010 a ->
             (match m4 with
              ...
              | Node010 b -> coq_Node Empty (f (Some a) (Some b)) Empty
              | Node011 (b, t0) ->
                coq_Node Empty (f (Some a) (Some b)) (combine_r (Nodes t0))
              | Node100 t0 ->
              ...
              | Node101 (t0, t1) ->
                coq_Node (combine_r (Nodes t0)) (f (Some a) None)
                  (combine_r (Nodes t1))
              | Node110 (t0, b) ->
                coq_Node (combine_r (Nodes t0)) (f (Some a) (Some b)) Empty
              | Node111 (t0, b, t1) ->
                coq_Node (combine_r (Nodes t0)) (f (Some a) (Some b))
                  (combine_r (Nodes t1)))
           | Node011 (a, t0) ->
             (match m4 with
              | Node001 t1 ->
              ...
              | Node010 b ->
                coq_Node Empty (f (Some a) (Some b)) (combine_l (Nodes t0))
              | Node011 (b, t1) ->
                coq_Node Empty (f (Some a) (Some b)) (tree_rec2'0 t0 t1)
              | Node100 t1 ->
              ...
              | Node101 (t1, t2) ->
                coq_Node (combine_r (Nodes t1)) (f (Some a) None)
                  (tree_rec2'0 t0 t2)
              | Node110 (t1, b) ->
                coq_Node (combine_r (Nodes t1)) (f (Some a) (Some b))
                  (combine_l (Nodes t0))
              | Node111 (t1, b, t2) ->
                coq_Node (combine_r (Nodes t1)) (f (Some a) (Some b))
                  (tree_rec2'0 t0 t2))
           | Node100 t0 ->
             (match m4 with
              ...
              | Node010 b ->
                coq_Node (combine_l (Nodes t0)) (f None (Some b)) Empty
              | Node011 (b, t1) ->
                coq_Node (combine_l (Nodes t0)) (f None (Some b))
                  (combine_r (Nodes t1))
              | Node100 t1 -> coq_Node (tree_rec2'0 t0 t1) None Empty
              | Node101 (t1, t2) ->
                coq_Node (tree_rec2'0 t0 t1) None (combine_r (Nodes t2))
              | Node110 (t1, b) ->
                coq_Node (tree_rec2'0 t0 t1) (f None (Some b)) Empty
              | Node111 (t1, b, t2) ->
                coq_Node (tree_rec2'0 t0 t1) (f None (Some b))
                  (combine_r (Nodes t2)))
           | Node101 (t0, t1) ->
             (match m4 with
              | Node001 t2 ->
              ...
              | Node110 (t2, b) ->
                coq_Node (tree_rec2'0 t0 t2) (f None (Some b))
                  (combine_l (Nodes t1))
              | Node111 (t2, b, t3) ->
                coq_Node (tree_rec2'0 t0 t2) (f None (Some b))
                  (tree_rec2'0 t1 t3))
             ...
             (match m4 with
              | Node001 t1 ->
                coq_Node (combine_l (Nodes t0)) (f (Some a) None)
                  (combine_r (Nodes t1))
              | Node010 b ->
                coq_Node (combine_l (Nodes t0)) (f (Some a) (Some b)) Empty
              | Node011 (b, t1) ->
                coq_Node (combine_l (Nodes t0)) (f (Some a) (Some b))
                  (combine_r (Nodes t1))
              | Node100 t1 ->
              ...
              | Node101 (t1, t2) ->
                coq_Node (tree_rec2'0 t0 t1) (f (Some a) None)
                  (combine_r (Nodes t2))
              | Node110 (t1, b) ->
                coq_Node (tree_rec2'0 t0 t1) (f (Some a) (Some b)) Empty
              | Node111 (t1, b, t2) ->
                coq_Node (tree_rec2'0 t0 t1) (f (Some a) (Some b))
                  (combine_r (Nodes t2)))
           | Node111 (t0, a, t1) ->
             (match m4 with
              | Node001 t2 ->
              ...
              | Node101 (t2, t3) ->
                coq_Node (tree_rec2'0 t0 t2) (f (Some a) None)
                  (tree_rec2'0 t1 t3)
              | Node110 (t2, b) ->
                coq_Node (tree_rec2'0 t0 t2) (f (Some a) (Some b))
                  (combine_l (Nodes t1))
              | Node111 (t2, b, t3) ->
                coq_Node (tree_rec2'0 t0 t2) (f (Some a) (Some b))
                  (tree_rec2'0 t1 t3))
