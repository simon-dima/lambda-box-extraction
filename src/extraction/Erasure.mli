...
module P :
 sig
  ...
  val term_rect :
    ...
    (term BasicAst.mfixpoint -> nat -> 'a1) -> (term BasicAst.mfixpoint ->
    nat -> 'a1) -> (term prim_val -> 'a1) -> term -> 'a1
  ...
  module PCUICEnvironment :
   sig
    ...
    ind_name : ident; ind_indices : context; ind_sort : Sort.t;
  ...
  module PCUICEnvTyping :
   sig
    ...
    val lift_sorting_extract :
      term option -> term -> Sort.t option -> ('a1, 'a2) lift_sorting ->
      ('a1, 'a2) lift_sorting
    ...
    val lift_sorting_it_impl_gen :
      term option -> term option -> term -> term -> Sort.t option -> ('a1,
      'a3) lift_sorting -> __ -> ('a3 -> 'a4) -> ('a2, 'a4) lift_sorting
    ...
    val lift_sorting_f_impl :
      PCUICEnvironment.judgment -> (term -> term) -> ('a1, 'a3) lift_sorting
      -> (term -> term -> 'a1 -> 'a2) -> (term -> Sort.t -> 'a3 -> 'a4) ->
      ('a2, 'a4) lift_sorting

    val lift_typing_f_impl :
      PCUICEnvironment.judgment -> (term -> term) -> 'a1 lift_typing0 ->
      (term -> term -> 'a1 -> 'a2) -> 'a2 lift_typing0
    ...
    val coq_All_local_env_snoc :
      PCUICEnvironment.context -> term BasicAst.context_decl -> 'a1
      coq_All_local_env -> 'a1 -> 'a1 coq_All_local_env

    val coq_All_local_env_tip :
      term BasicAst.context_decl list -> term BasicAst.context_decl -> 'a1
      coq_All_local_env -> 'a1 coq_All_local_env * 'a1

    val coq_All_local_env_ind1 :
      'a2 -> (term BasicAst.context_decl list -> term BasicAst.context_decl
      -> 'a2 -> 'a1 -> 'a2) -> PCUICEnvironment.context -> 'a1
    ...
    val coq_All_local_env_impl_gen :
      PCUICEnvironment.context -> 'a1 coq_All_local_env ->
      (PCUICEnvironment.context -> term BasicAst.context_decl -> 'a1 -> 'a2)
    ...
    val coq_All_local_env_app_skipn :
      term BasicAst.context_decl list -> term BasicAst.context_decl list ->
      nat -> 'a1 coq_All_local_env -> 'a1 coq_All_local_env

    val coq_All_local_env_nth_error :
      PCUICEnvironment.context -> nat -> term BasicAst.context_decl -> 'a1
      coq_All_local_env -> 'a1

    val coq_All_local_env_cst :
      PCUICEnvironment.context -> ('a1 coq_All_local_env, (term
      BasicAst.context_decl, 'a1) coq_All) iffT

    type 'p coq_All_local_rel = 'p coq_All_local_env

    val coq_All_local_rel_nil :
      term BasicAst.context_decl list -> 'a1 coq_All_local_rel

    val coq_All_local_rel_snoc :
      term BasicAst.context_decl list -> PCUICEnvironment.context -> term
      BasicAst.context_decl -> 'a1 coq_All_local_rel -> 'a1 -> 'a1
      coq_All_local_rel
    ...
    val coq_All_local_rel_def :
      term BasicAst.context_decl list -> PCUICEnvironment.context -> term ->
      term -> aname -> 'a1 coq_All_local_rel -> 'a1 -> 'a1 coq_All_local_rel

    val coq_All_local_rel_tip :
      term BasicAst.context_decl list -> term BasicAst.context_decl list ->
      term BasicAst.context_decl -> 'a1 coq_All_local_rel -> 'a1
      coq_All_local_rel * 'a1

    val coq_All_local_rel_ind1 :
      term BasicAst.context_decl list -> 'a2 -> (term BasicAst.context_decl
      list -> term BasicAst.context_decl -> 'a2 -> 'a1 -> 'a2) ->
      PCUICEnvironment.context -> 'a1 coq_All_local_rel -> 'a2
    ...
    val coq_All_local_app_rel :
      term BasicAst.context_decl list -> term BasicAst.context_decl list ->
      'a1 coq_All_local_env -> 'a1 coq_All_local_env * 'a1 coq_All_local_rel
    ...
    val coq_All_local_rel_app_inv :
      term BasicAst.context_decl list -> term BasicAst.context_decl list ->
      term BasicAst.context_decl list -> 'a1 coq_All_local_rel -> 'a1
    ...
    val coq_All_local_rel_app :
      term BasicAst.context_decl list -> PCUICEnvironment.context ->
      PCUICEnvironment.context -> 'a1 coq_All_local_rel -> 'a1
      coq_All_local_rel -> 'a1 coq_All_local_rel
    ...
    val coq_All_local_env_lift_prod_inv :
      ...
      -> 'a1 lift_typing0 coq_All_local_env * 'a2 lift_typing0
      coq_All_local_env

    type ('checking, 'sorting, 'cproperty, 'sproperty) coq_All_local_env_over_sorting = (
    'checking, 'sorting, 'cproperty, 'sproperty) PCUICEnvTyping.coq_All_local_env_over_sorting =
    ...
    val nth_error_All_local_env_over :
      term BasicAst.context_decl list -> nat -> term BasicAst.context_decl ->
      'a1 lift_typing0 coq_All_local_env -> ('a1, 'a2) coq_All_local_env_over
    ...
    val ctx_inst_rect :
      ...
      -> PCUICEnvironment.context -> 'a1 -> 'a1 ctx_inst -> 'a2 -> 'a2) ->
      (aname -> term -> term -> term list -> PCUICEnvironment.context -> 'a1
      ctx_inst -> 'a2 -> 'a2) -> term list -> PCUICEnvironment.context -> 'a1
      ctx_inst -> 'a2
    ...
    val ctx_inst_sig_pack :
      PCUICEnvironment.context -> term list -> PCUICEnvironment.context ->
      'a1 ctx_inst -> (term list * PCUICEnvironment.context) * 'a1 ctx_inst

    val ctx_inst_Signature :
      PCUICEnvironment.context -> term list -> PCUICEnvironment.context ->
      ('a1 ctx_inst, term list * PCUICEnvironment.context, 'a1 ctx_inst_sig)
      coq_Signature
    ...
    val ctx_inst_impl :
      PCUICEnvironment.context -> term list -> PCUICEnvironment.context ->
      'a1 ctx_inst -> (term -> term -> 'a1 -> 'a2) -> 'a2 ctx_inst
    ...
    val coq_All_local_rel_size :
      (PCUICEnvironment.context -> term -> term -> 'a1 -> size) ->
      PCUICEnvironment.context -> PCUICEnvironment.context -> 'a1
      lift_typing0 coq_All_local_rel -> size
    ...
    val coq_All_local_rel_sorting_size :
      ...
      BasicAst.context_decl list -> PCUICEnvironment.context -> ('a1, 'a2)
      lift_sorting coq_All_local_rel -> size
   end
  ...
  module PCUICConversion :
   sig
    ...
    val coq_All_decls_alpha_pb_impl :
      conv_pb -> term BasicAst.context_decl -> term BasicAst.context_decl ->
      (conv_pb -> term -> term -> 'a1 -> 'a2) -> 'a1 coq_All_decls_alpha_pb
      -> 'a2 coq_All_decls_alpha_pb
   end
  ...
  module PCUICGlobalMaps :
   sig
    ...
    val positive_cstr_arg_rect :
      ...
      list -> nat -> PCUICEnvironment.one_inductive_body -> __ -> (term, __)
      coq_All -> __ -> 'a1) -> (term BasicAst.context_decl list -> aname ->
      term -> term -> term -> positive_cstr_arg -> 'a1 -> 'a1) -> (term
      BasicAst.context_decl list -> aname -> term -> term -> __ ->
    ...
    val positive_cstr_rect :
      PCUICEnvironment.mutual_inductive_body -> nat -> (term
      BasicAst.context_decl list -> term list -> (term, __) coq_All -> 'a1)
      -> (term BasicAst.context_decl list -> aname -> term -> term -> term ->
      positive_cstr -> 'a1 -> 'a1) -> (term BasicAst.context_decl list ->
      aname -> term -> term -> positive_cstr_arg -> positive_cstr -> 'a1 ->
      'a1) -> term BasicAst.context_decl list -> term -> positive_cstr -> 'a1
    ...
    val on_global_env_ext_empty_ext :
      checker_flags -> PCUICEnvironment.global_env -> ('a1, 'a2)
      on_global_env -> ('a1, 'a2) on_global_env_ext

    val type_local_ctx_impl_gen :
      PCUICEnvironment.global_env_ext -> PCUICEnvironment.context ->
      PCUICEnvironment.context -> Sort.t -> __ list -> (__, __
      type_local_ctx) sigT -> (PCUICEnvironment.context ->
      PCUICEnvironment.judgment -> (__, __) coq_All -> 'a1) -> (__, __
      type_local_ctx) coq_All -> 'a1 type_local_ctx
    ...
    val type_local_ctx_impl :
      ...
      type_local_ctx -> (PCUICEnvironment.context ->
      PCUICEnvironment.judgment -> 'a1 -> 'a2) -> 'a2 type_local_ctx
    ...
    val cstr_respects_variance_impl_gen :
      ...
      -> Variance.t list -> PCUICEnvironment.constructor_body -> __ list ->
      (__, __ cstr_respects_variance) sigT -> __ -> (__, __
      cstr_respects_variance) coq_All -> 'a1 cstr_respects_variance
    ...
    val on_global_decl_impl_full :
      ...
      (universes_decl -> Variance.t list option -> on_variance ->
      on_variance) -> ('a1, 'a3) on_global_decl -> ('a2, 'a4) on_global_decl
  ...
  val positive_cstr_rect :
    ...
    BasicAst.context_decl list -> term list -> (term, __) coq_All -> 'a1) ->
    (term BasicAst.context_decl list -> aname -> term -> term -> term ->
    positive_cstr -> 'a1 -> 'a1) -> (term BasicAst.context_decl list -> aname
    -> term -> term -> positive_cstr_arg -> positive_cstr -> 'a1 -> 'a1) ->
    term BasicAst.context_decl list -> term -> positive_cstr -> 'a1
