 ...
 struct
  module Raw =
   struct
    ...
    | Coq_xI n0 -> treeify_cont (treeify_aux false n0) (treeify_aux pred n0)
    | Coq_xO n0 -> treeify_cont (treeify_aux pred n0) (treeify_aux true n0)
    | Coq_xH -> if pred then treeify_zero else treeify_one
